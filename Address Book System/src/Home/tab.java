...
private final ButtonGroup buttonGroup_2 = new ButtonGroup();
	...
	public tab() {
		...
		tabbedPane.addTab("Fill in The blanks", null, panel, null);
		...
		textField_5.setBounds(467, 234, 199, 34);
		...
		radioButton.setBounds(467, 293, 101, 23);
		...
		radioButton_1.setBounds(577, 293, 89, 23);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				obj.insert(textField.getText(),textField_1.getText(),textField_2.getText(),textField_3.getText(),textField_4.getText(),textField_5.getText(),c);
			}
		});
		panel_3.add(button);
		
		JLabel lblCostumerNo = new JLabel("Address No#");
		...
		JLabel lblTutionFees = new JLabel("Parmanent Address:");
		...
		label_6.setBounds(138, 295, 168, 19);
		label_6.setFont(new Font("Tahoma", Font.BOLD, 15));
		panel_3.add(label_6);
		
		JLabel lblAdmissionForm = new JLabel("Address Book");
		...
		tabbedPane.addTab("Delete Address", null, panel_1, null);
		...
		JLabel lblEnterRegistrationNo = new JLabel("Enter Address  NO:");
		...
		JLabel lblDeleteOrder = new JLabel("Delete Address");
		...
		tabbedPane.addTab("Show Address", null, panel_6, null);
		...
		JLabel lblRegistrationNo = new JLabel("Address No#");
		...
		radioButton_4.setBounds(308, 308, 109, 23);
		...
		radioButton_5.setBounds(430, 308, 109, 23);
		...
		label_24.setBounds(96, 301, 155, 32);
